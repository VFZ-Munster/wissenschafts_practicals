...
<span style="font-weight: 400; font-size: 16px;">Subtract the percentage values:</span>
$$
...
<span style="font-weight: 400; font-size: 16px;">Divide the percentage values:</span>
$$
...
The ratio of odds between the two groups:
</div>

  <!-- Left column -->
<div class="box" style="min-width: 0;">
<span style="font-weight: 400; font-size: 16px;">The odds of periodontitis for diabetics:</span>
$$
...
$$
  ...
  <!-- Right column -->
<div class="box" style="min-width: 0;">
<span style="font-weight: 400; font-size: 16px;">Divided by the odds of periodontitis for non-diabetics:</span>
$$
...
$$
  ...
  <!-- Final OR -->
<div class="box" style="grid-column: 1 / 3; text-align: center;">
Final odds ratio
$$
