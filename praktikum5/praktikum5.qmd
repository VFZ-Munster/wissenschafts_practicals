...
![Histogram of the distribution of mean attachment loss](hist_cal.png){width="80%"}

![Q-Q plot of the distribution of mean attachment loss](qq_cal.png){width="80%"}
...
![Histogram of the distribution of the natural logarithm of attachment loss](hist_ln_loss.png){width="80%"}

![Q-Q plot of the distribution of the natural logarithm of attachment loss](qq_ln_loss.png){width="80%"}
...
![Scatter plot ln_loss vs alcg](scatter_alc_ln_loss.png){width="80%"}

![Scatter plot ln_loss vs height](scatter_height_ln_loss.png){width="80%"}

![Scatter plot ln_loss vs weight](scatter_weight_ln_loss.png){width="80%"}
...
![](linear_regression.png){width="50%" fig-align="center"}
...
![](linear_regression2.png){width="50%" fig-align="center"}
...
![](linear_regression3.png){width="50%" fig-align="center"}
...
![](linear_regression4.png){width="50%" fig-align="center"}

Click [Options...]{.spss-button} and select **Modified Breusch-Pagan test** and **Parameter estimates with robust standard error**.

![](linear_regression5.png){width="50%" fig-align="center"}

<details>
<summary><img alt="Static Badge" src="https://img.shields.io/badge/Task-Results-green"></summary>

![](test_homoscedasticity.png){width="80%" fig-align="center"}
