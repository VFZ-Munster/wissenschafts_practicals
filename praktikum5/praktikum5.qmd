...
<summary>Task results: cal_mean</summary>

::: {.result-figure-grid}
::: {.result-figure}
![Histogram of the distribution of mean attachment loss](hist_cal.png)
:::

::: {.result-figure}
![Q-Q plot of the distribution of mean attachment loss](qq_cal.png)
:::
:::
...
<summary>Task results: ln_loss</summary>

::: {.result-figure-grid}
::: {.result-figure}
![Histogram of the distribution of the natural logarithm of attachment loss](hist_ln_loss.png)
:::

::: {.result-figure}
![Q-Q plot of the distribution of the natural logarithm of attachment loss](qq_ln_loss.png)
:::
:::
...
::: {.result-figure-grid}
::: {.result-figure}
![Scatter plot ln_loss vs alcg](scatter_alc_ln_loss.png)
:::

::: {.result-figure}
![Scatter plot ln_loss vs height](scatter_height_ln_loss.png)
:::

::: {.result-figure .wide}
![Scatter plot ln_loss vs weight](scatter_weight_ln_loss.png)
:::
:::
...
::: {.result-figure-grid}
::: {.result-figure}
![Select the source and target variables](create_male1.png)
:::

::: {.result-figure}
![Configure the recoding values](create_male2.png)
:::

::: {.result-figure}
![Confirm the new dummy variable](create_male3.png)
:::
:::
